...
void	Bureaucrat::signForm(AForm &form) const
{
	...
	{
		std::cout << this->getName() << " couldn’t sign " << form.getName() << " because the bureaucrat grade is to low." << std::endl;
	}
}
...
void	Bureaucrat::executeForm(AForm const &form) const {
	...
	{
		std::cout << this->_name << " cant execute " << form.getName() << " because of the exception : " << e.what() << std::endl;
	}
}
